...
//  AdButler
//
//  Created by Will Prevett on 2018-08-01.
...
import WebKit
import UIKit
public class ABMRAIDBrowserWindow : UIViewController, WKUIDelegate, WKNavigationDelegate {
    ...
    private static var dividerImage = UIImage(named: "navigationDivider", in: Bundle(identifier:"sparklit.AdButler"), compatibleWith:nil)
    ...
    private func addNavigationButtons(){
        ...
        btnForward!.setImage(UIImage(named: "navigationForward", in: Bundle(identifier:"sparklit.AdButler"), compatibleWith:nil), for:UIControl.State.normal)
        btnBack!.setImage(UIImage(named: "navigationBack", in: Bundle(identifier:"sparklit.AdButler"), compatibleWith:nil), for:UIControl.State.normal)
        btnReload!.setImage(UIImage(named: "navigationReload", in: Bundle(identifier:"sparklit.AdButler"), compatibleWith:nil), for:UIControl.State.normal)
        btnClose!.setImage(UIImage(named: "navigationClose", in: Bundle(identifier:"sparklit.AdButler"), compatibleWith:nil), for:UIControl.State.normal)
    ...
    private func addButtonConstraints(){
        ...
        btnBack!.addConstraint(NSLayoutConstraint(item:btnBack!, attribute: .width, relatedBy:.equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant:ABMRAIDBrowserWindow.btnWidth))
        btnBack!.addConstraint(NSLayoutConstraint(item:btnBack!, attribute: .height, relatedBy:.equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant:ABMRAIDBrowserWindow.btnHeight))
        // dividerleft
        ...
        dividerLeft.addConstraint(NSLayoutConstraint(item:dividerLeft, attribute: .height, relatedBy:.equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant:ABMRAIDBrowserWindow.btnHeight * 0.75))
        // reload
        ...
        btnReload!.addConstraint(NSLayoutConstraint(item:btnReload!, attribute: .width, relatedBy:.equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant:ABMRAIDBrowserWindow.btnWidth))
        btnReload!.addConstraint(NSLayoutConstraint(item:btnReload!, attribute: .height, relatedBy:.equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant:ABMRAIDBrowserWindow.btnHeight))
        // dividerRight
        ...
        dividerRight.addConstraint(NSLayoutConstraint(item:dividerRight, attribute: .height, relatedBy:.equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant:ABMRAIDBrowserWindow.btnHeight * 0.75))
        // forward
        ...
        btnForward!.addConstraint(NSLayoutConstraint(item:btnForward!, attribute: .width, relatedBy:.equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant:ABMRAIDBrowserWindow.btnWidth))
        btnForward!.addConstraint(NSLayoutConstraint(item:btnForward!, attribute: .height, relatedBy:.equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant:ABMRAIDBrowserWindow.btnHeight))
        // close
        ...
        btnClose!.addConstraint(NSLayoutConstraint(item:btnClose!, attribute: .width, relatedBy:.equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant:ABMRAIDBrowserWindow.btnWidth))
        btnClose!.addConstraint(NSLayoutConstraint(item:btnClose!, attribute: .height, relatedBy:.equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant:ABMRAIDBrowserWindow.btnHeight))
    }
